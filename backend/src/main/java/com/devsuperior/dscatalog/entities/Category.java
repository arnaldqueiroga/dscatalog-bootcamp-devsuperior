...
@Entity
@Table(name = "tb_category") // anotation para definir o nome da tabela
public class Category implements Serializable {
	...
	// Declarando lista de produtos associado a uma categoria
	...
	// Construtor com argumentos como opção
